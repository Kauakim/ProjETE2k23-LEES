...
void AtualizarInicial()
{
  ...
  doc["Frequencia1"] = FrequenciaMediaInicial1;
  doc["Frequencia2"] = FrequenciaMediaInicial2;
  doc["Frequencia3"] = FrequenciaMediaInicial3;
  doc["Frequencia4"] = FrequenciaMediaInicial4;
...
void AtribuicaoMagnetica()
{
  ...
  if (LeituraSensor >= 850 && LeituraSensor <= 1000)
  {
    ContadorMedido = 5;
  }
  else if (LeituraSensor >= 1600 && LeituraSensor <= 1800)
  {
    ContadorMedido = 4;
  }
  else if (LeituraSensor >= 2150 && LeituraSensor <= 2400)
  {
    ContadorMedido = 3;
  }
  else if (LeituraSensor >= 2550 && LeituraSensor <= 2900)
  {
    ContadorMedido = 2;
  }
  else if (LeituraSensor >= 3100 && LeituraSensor <= 3500)
  {
    ContadorMedido = 1;
  }
}
...
void AnaliseCorrigida()
{
  ...
  while (VariavelAnalise == 1)
  {
    ...
    {
      Serial.println("A medicao das frequencias não funcionou.");
    ...
    {
      Serial.println("A medicao das frequencias funcionou completamente.");
...
void loop()
{
  ...
  Serial.print(",");
  Serial.print(FrequenciaProcessada2);
  Serial.print(",");
  ...
  //Decidir qual é o material do lixo descartado
  ...
  while (DistanciaS2 >= 16 && DistanciaS2 <= 20)
  {
    ...
    Serial.println("Descarte o lixo na lixeira");
